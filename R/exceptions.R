...
EXCEPTION_TABLE <- tibble::tribble(
  ...
  "5", "Error loading treatment", "There were errors when loading the treatments. See logs:\n%s", "error", "treatment",
  ...
  "19", "Error loading treatment", "There were errors loading the treatment. Please see the logs:\n%s", "error", "treatment",
  "20", "Error loading specific treatment", "There were errors loading treatment %s. Please see logs: \n%s", "error", "treatment",
