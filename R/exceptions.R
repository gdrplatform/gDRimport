...
EXCEPTION_TABLE <- tibble::tribble(
  ...
  "36", "Invalid averaged data", "Averaged dose-reponse data for the selected cell line and drug:'%s' is invalid. Please contanct gdrplatform team via 'gdr-support-d@gene.com'.", "error", "assay data"
)
#nolint end
